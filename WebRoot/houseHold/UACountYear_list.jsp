...
<body>
    ...
    <div class="easyui-tabs" fit="true" plain="true" style="height:500px;width:800px;">
		<div title="个人收入vs支出" style="padding:10px;">
		...
		<div title="家庭收入vs支出" style="padding:10px;">
			<h2 id="area">家庭收入vs支出趋势图</h2>
			<table id="myTable2" class="tablelist">
				...
				<tr><th>支出总和</th>
					...
					<s:iterator value="faUacss" id="uac" >
						<td><s:property value="#uac.sumMoney" /></td>
					</s:iterator>
				</tr>
				</tbody>
			</table>
			<span class="totalsum">家庭收入总计:<s:property value="finsumTotal"/></span>
			<span class="totalsum">家庭支出总计:<s:property value="foutsumTotal"/></span>
			<span class="totalsum">家庭实际总计:<s:property value="finsumTotal-foutsumTotal"/></span>
		</div>
     ...
     <input hidden="true" id="role" value="<s:property value='role'/>" />
