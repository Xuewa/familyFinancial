...
<frameset rows="88,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="187,*" frameborder="no" border="0" framespacing="0">
    <frame src="familyMember/left.jsp?userID=<s:property value="user.userID"/>&role=<s:property value='user.role'/>" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" title="leftFrame" />
...
<body>
<s:bean name="user" var="user"></s:bean>
</body>
</html>
