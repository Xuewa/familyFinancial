...
(function($) {
    ...
    function _2c0(_2c1, _2c2) {
        ...
        $.data(tab[0], "tabs.tab", 
        		{ id: _2c2.id, 
        	title: _2c2.title, 
        	href: _2c2.href, loaded: false, cache: _2c2.cache });
    };
    function _2c6(_2c7, _2c8) {
        _2c8 = $.extend({ id: null, 
        	title: "", content: "", 
        	href: null, cache: true, 
        	icon: null, closable: false, 
        	selected: true, height: "auto", width: "auto" }, _2c8 || {});
        if (_2c8.selected) {
            $(".tabs-header .tabs-wrap .tabs li", _2c7).removeClass("tabs-selected");
        }
        _2c8.id = _2c8.id || "gen-tabs-panel" + $.fn.tabs.defaults.idSeed++;
        $("<div></div>").attr("id", _2c8.id).
        attr("title", _2c8.title).height(_2c8.height).
        width(_2c8.width).appendTo($(">div.tabs-panels", _2c7));
        _2c0(_2c7, _2c8);
    };
