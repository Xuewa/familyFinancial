; (function($) {  
    $.simpleCanleder = function(box, options){  
        ...
        function _buildCanlederBox(){  
            ...
            _buildTitle(canlederBox,yearnow,monthnow);  
            _buildBody(canlederBox,yearnow,monthnow);  
        ...
        function _buildTitle(canlederBox,yearnow,monthnow){  
        ...
        function _buildBody(canlederBox,yearnow,monthnow){  
            ...
            for(var i = 0; i < 12; i++){  
                ...
                var $li = $("<li/>").append($inner).click(function(){  
                    year = canlederBox.find(_title_ul_li).eq(1).find("select").val();  
